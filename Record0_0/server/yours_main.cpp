...
static void set_config(bds::BDSSDKMessage &cfg_params) {
    ...
    const std::string app_key = "ypcdAcc30au3DVp6oVXgXqmZ";
    const std::string app_secret = "5pf9hMb7GywX2dMuIG9gPhe55F7MAycG ";
...
/**识别单个文件*/
static void recog_one_file(string );
...
int main(int argc, char **argv) {
    ...
    recog_one_file(filename); // 识别一个文件
 ...
 * 识别一个文件
 */
static void recog_one_file(string filename) {
    filename = string("../pcm/") + filename;
