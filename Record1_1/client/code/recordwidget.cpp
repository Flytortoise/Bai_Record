...
RecordWidget::RecordWidget(QWidget *parent)
    : QWidget(parent)
{
    this->setWindowTitle(tr("录音"));
    CreateInit();
    CreateLaytout();
    this->setFixedSize(225, 80);
}


void RecordWidget::CreateInit()
{
    ...
    connect(_startBtn,&QPushButton::clicked,[&]()->void{
             ...
             #ifdef TOFILE //存到文件
                QString fileName = QString("./%1-%2.wav").arg(
    ...
    connect(_endBtn,&QPushButton::clicked,[&]()->void{
        ...
        //写到IO设备头
                ...
                outFile.close();
                emit RecordOk(filename);
            });
}

void RecordWidget::CreateLaytout()
{
